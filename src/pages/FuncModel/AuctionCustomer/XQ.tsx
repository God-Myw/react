...
import { Col, Form, Input, Modal, Row, Upload, Icon, message, Checkbox, Button, Radio  } from 'antd';
                ...
                <Col span={12}>
                  <Form.Item {...formlayout} label='竞拍开始时间'>
                    <Input
                      disabled
                      value={
                        isNil(this.state) || isNil(this.state.startTime) ? '' : this.state.startTime
                      }
                    />
                  </Form.Item>
                </Col>
              ...
              <Row gutter={24}>
                <Col span={12}>
                  <Form.Item {...formlayout} label='报名人数'>
                    <Input
                      disabled
                      value={
                        isNil(this.state) || isNil(this.state.applicantsCount) ? '' : this.state.applicantsCount
                      }
                    />
                  </Form.Item>
                </Col>
                ...
                <Form.Item {...formlayout} label='关注人数'>
                    <Input
                      disabled
                      value={
                        isNil(this.state) || isNil(this.state.followSum) ? '' : this.state.followSum
                      }
                    />
                  </Form.Item>
                </Col>
                ...
                <Col span={12}>
                  <Form.Item {...formlayout} label='围观人数'>
                    <Input
                      disabled
                      value={
                        isNil(this.state) || isNil(this.state.hitsSum) ? '' : this.state.hitsSum
                      }
                    />
                  </Form.Item>
                </Col>
                  ...
                  <Row gutter={24}>
                    <Col>
                      <Form.Item {...smallFormItemLayout} label="订单完成">
                        <Checkbox onChange={this.onChange}>已完成</Checkbox>
                      </Form.Item>
                    </Col>
                  </Row>
                  <Row gutter={24}>
