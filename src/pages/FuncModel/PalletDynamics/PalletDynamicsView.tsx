      ...
      if (response.status === 200) {
        if (!isNil(response.data)) {
          ...
          this.setState({
            ...
            palletNumber:response.data.pallet.palletNumber,
          });
        ...
        <div className={commonCss.AddForm}>
          <Form labelAlign="left">
              ...
              <Col span={12}>
                <Form.Item {...formlayout} label='货物编号'>
                  <Input
                    disabled
                    value={
                      isNil(this.state) || isNil(this.state.palletNumber) ? '' : this.state.palletNumber
                    }
                  />
                </Form.Item>
              </Col>
              ...
              <Col span={12}>
                <Form.Item {...formlayout} label='货物重量'>
                  <Input
                    ...
                    value={
                      isNil(this.state) || isNil(this.state.goodsWeight) ? '' : (this.state.goodsWeight+'至'+this.state.goodsMaxWeight)
                    }
                  />
                </Form.Item>
              </Col>
                ...
                !isNil(this.state) && this.state.CGCG == 'G'?(
                  ...
                  <Form.Item {...formlayout} label="所需船舶吨位">
                    <Input
                      ...
                      disabled
                      value={
                        isNil(this.state) || isNil(this.state.goodsVolume) ? '' : this.state.weightMin - this.state.weightMax
                      }
                    />
                  </Form.Item>
              </Col>
            ...
            {!isNil(this.state) && this.state.CGCG == 'G' ? (
              <div>
                ...
                <Row gutter={24}>
                  ...
                  <Col span={12}>
                    <Form.Item {...formlayout} label='意向条款'>
                      <Input
                        disabled
                        className="OnlyRead"
                        value={
            ...
            {/* {!isNil(this.state) && this.userType == '3' ? (
              ...
              <div className={commonCss.title}>
                <span className={commonCss.text}>客服报价</span>
              </div>
              <Form labelAlign="left">
              <Row gutter={24}>
                <Col span={24}>
                    <Form.Item {...smallFormItemLayout} label="货运报价详情">
                    <Input  disabled style={{ height: '50px' }}
                         value={
                          isNil(this.state) || isNil(this.state.price1) ? '' : this.state.price1+'元'
                        }
                    />
                    </Form.Item>
                </Col>
              ...
              <Row gutter={24}>
                <Col span={24}>
                    <Form.Item {...smallFormItemLayout} label="修改货运报价">
              ...
              <Row gutter={24}>
                <Col span={24}>
                    <Form.Item {...smallFormItemLayout} label="其他服务报价详情">
                    <Input  disabled style={{ height: '50px' }}
                         value={
                          isNil(this.state) || isNil(this.state.insurancePrice1) ? '' : this.state.insurancePrice1+'元'
                        }
                    />
                    </Form.Item>
                </Col>
              ...
              <Row gutter={24}>
                <Col span={24}>
                    <Form.Item {...smallFormItemLayout} label="修改其他服务报价">
                        {/* <Input  style={{ height: '100px' }}
                          onChange={e => this.setState({ insurancePrice: e.target.value })}
                        /> */}
                        {
