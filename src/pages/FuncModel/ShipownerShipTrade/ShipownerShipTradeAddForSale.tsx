...
import { checkEmail, checkNumber, HandleBeforeUpload } from '@/utils/validator';
...
import { ShipownerShipTradeFormProps, PicList, FileMsg } from './ShipownerShipTradeFormInterface';
...
class ShipownerShipTradeAddForSale extends React.Component<
  ...
  handleChangeSpe = (info: any) => {
    ...
    }, () => (console.log(this.state.specificationFileList)));
    forEach(info.fileList, (pic, index) => {
      if (pic.status === 'done') {
        count++;
      }
              ...
              <Col span={12}>
                ...
                >
                  {getFieldDecorator('shipAge', {
                    ...
                    <Select allowClear={true} 
                    placeholder={formatMessage({ id: 'ShipownerShipTrade-ShipownerShipTradeList.shipAge' })}
