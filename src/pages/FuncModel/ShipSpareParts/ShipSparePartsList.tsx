    ...
    },
    {
      ...
      render: (v: any) => (
        <span style={{ width: '100%', display: 'flex', justifyContent: 'space-around' }}>
          <img style={{ width: '70px', height: '23px' }} src={`http://58.33.34.10:10443/images/spart/${v}`} alt="" />
        </span>
      )
    },
    {
            ...
            <Col span={24}>
              <InputGroup compact>
                ...
                <QueryButton
                  type="Add"
                  text="新增商品"
                  event={() => { this.props.history.push('/spartPart/add/') }}
                  disabled={true}
                />
              </InputGroup>
            </Col>
...
const MPCertificationList_Form = Form.create({ name: 'MPCertificationList_Form' })(ShipSparePartsList);
