...
import { ShipNeedsFormInterface, FileMsg } from './ShipNeedsFormInterface';

class ShipownerShipTradeView extends React.Component<ShipNeedsFormInterface, ShipNeedsFormInterface> {
