...
import { ShipTradeFormProps, FileMsg } from './ShipTradeFormInterface';

class ShipownerShipTradeView extends React.Component<ShipTradeFormProps, ShipTradeFormProps> {
