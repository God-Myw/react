...
import { forEach, isNil, zipWith } from 'lodash';
...
class PalletAdd extends React.Component<PalletFormProps, PalletProps> {
  ...
  handleSubmit(type: number, flag: string) {
    // console.log(this.props.neirong.goodsLevel)
      ...
      if (!err) {
        ...
        if (flag === '2') {
          requestData = {
            ...
            weightMin: values.goodsWeight,//最小吨位
            weightMax: values.goodsVolume,//最大吨位
...
handleCancel = () => {
      ...
      <div className={commonCss.container}>
        <div className={commonCss.AddForm}>
          ...
          <div className={commonCss.title}>
              <span className={commonCss.text}>运输需求</span>
          </div>
          ...
          <Row gutter={24}>
              <Col span={12}>
                <Form.Item
                  {...formlayout}
                  label={formatMessage({ id: 'pallet-palletAdd.loading.time' })}//受载日期
                >
                  {getFieldDecorator(`loadDate`, {
                    ...
                    rules: [
                      {
                        required: true,
                        message: formatMessage({ id: 'pallet-palletAdd.loading.time.null' }),//'受载日期不能为空
                      },
                      {
                    ...
                    <DatePicker
                      ...
                      format={FORMAT}
                      style={{ width: '100%' }}
                      placeholder={formatMessage({ id: 'pallet-palletAdd.loading.time.enter' })}//请输入受载日期
              ...
              <Col span={12}>
                <Form.Item
                  {...formlayout}
                  label={formatMessage({ id: 'pallet-palletAdd.deadline' })}//截止日期
                >
                  {getFieldDecorator(`endDate`, {
                    ...
                    rules: [
                      {
                        required: true,
                        message: formatMessage({ id: 'pallet-palletAdd.deadline.null' }),//截止日期不能为空
                      },
                      {
                    ...
                    <DatePicker
                      ...
                      format={FORMAT}
                      style={{ width: '100%' }}
                      placeholder={formatMessage({ id: 'pallet-palletAdd.deadline.enter' })}//'请输入截止日期
                ...
                >
                  {getFieldDecorator(`goodsWeight`, {
                    ...
                    <Input
                      maxLength={15}
                      placeholder='请输入最小吨位'
                      suffix={formatMessage({ id: 'pallet-palletAdd.goods.weight.t' })}//'吨
                ...
                >
                  {getFieldDecorator(`contacter`, {
                    ...
                    rules: [
                      {
                        required: true,
                        message: formatMessage({ id: 'pallet-palletAdd.linkman.null' }),//联系人不能为空
                      },
                    ],
                  })(
                    <Input
                      maxLength={20}
                      placeholder={formatMessage({ id: 'pallet-palletAdd.linkman.enter' })}//请输入联系人
                ...
                >
                  {getFieldDecorator(`contactPhone`, {
                    ...
                    rules: [
                      {
                        required: true,
                        message: formatMessage({ id: 'pallet-palletAdd.contact.way.null' }),//联系方式不能为空
                      },
                      {
                        pattern: new RegExp(/^[0-9]\d*$/),
                        message: formatMessage({ id: 'insuranceForShipper-insuranceAdd.phonenumber.enter.correct' }),//请输入正确的手机号码
                      },
                    ],
                  })(
                    <Input
                      ...
                      placeholder={formatMessage({ id: 'pallet-palletAdd.contact.way' })}//联系方式
                      style={{ width: '100%' }}
  ...
  private newMethod() {
    confirm({
      title: formatMessage({ id: 'Common-Publish.confirm.not' }),//提交后无法修改，是否确认提交
      okText: formatMessage({
        id: 'Common-Publish.publish.confirm',//确认
      }),
      cancelText: formatMessage({
        id: 'Common-Publish.publish.cancle',//取消
      }),
      onOk: () => {
